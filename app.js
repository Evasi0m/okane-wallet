...
var ICON_LIST={
shopee:'<svg '+_s+'><path d="M5 8h14l-1 11.5a1.5 1.5 0 01-1.5 1.5h-9A1.5 1.5 0 016 19.5z"/><path d="M8.5 8V6.5a3.5 3.5 0 017 0V8"/></svg>',
grab:'<svg '+_s+'><path d="M20 10c0 5.5-8 11.5-8 11.5S4 15.5 4 10a8 8 0 0116 0z"/><circle cx="12" cy="10" r="2.5"/></svg>',
netflix:'<svg '+_s+'><path d="M7 4v16M17 4v16M7 4l10 16"/></svg>',
youtube:'<svg '+_s+'><rect x="2" y="5" width="20" height="14" rx="4"/><path d="M10 9l5 3-5 3z" fill="currentColor" stroke="none"/></svg>',
lineman:'<svg '+_s+'><path d="M6 9l1.5-4h9L18 9v10a2 2 0 01-2 2H8a2 2 0 01-2-2z"/><path d="M6 9h12"/><path d="M9.5 13h5"/></svg>',
starbucks:'<svg '+_s+'><path d="M7 9h10l-1 11a1.5 1.5 0 01-1.5 1.5h-5A1.5 1.5 0 018 20z"/><path d="M6 9h12l-1-3.5H7z"/></svg>',
truemoney:'<svg '+_s+'><rect x="3" y="5" width="18" height="14" rx="2"/><path d="M3 9h18"/><circle cx="7" cy="14" r="1.5"/></svg>',
kasikornbank:'<svg '+_s+'><path d="M4 10l8-5 8 5"/><path d="M3 20h18"/><path d="M5 10v10M9 10v10M15 10v10M19 10v10"/></svg>',
scb:'<svg '+_s+'><path d="M12 3l8 3v5.5c0 5-3.5 8-8 9.5-4.5-1.5-8-4.5-8-9.5V6z"/></svg>',
visa:'<svg '+_s+'><rect x="2" y="5" width="20" height="14" rx="2"/><path d="M2 9h20"/><path d="M6 15h5"/></svg>',
coffee:'<svg '+_s+'><path d="M4 8h12v7a4 4 0 01-4 4H8a4 4 0 01-4-4z"/><path d="M16 10h2a2 2 0 010 4h-2"/><path d="M8 3v2M12 3v2"/></svg>',
house:'<svg '+_s+'><path d="M4 11l8-7 8 7"/><path d="M6 9.5V20h12V9.5"/><path d="M10 20v-5h4v5"/></svg>',
phone:'<svg '+_s+'><rect x="6" y="2" width="12" height="20" rx="2.5"/><path d="M10 18h4"/></svg>',
pill:'<svg '+_s+'><rect x="2.5" y="8.5" width="19" height="7" rx="3.5" transform="rotate(-45 12 12)"/><line x1="8.8" y1="15.2" x2="15.2" y2="8.8"/></svg>',
graduation:'<svg '+_s+'><path d="M3 9l9-4 9 4-9 4z"/><path d="M7 11v5c0 1.2 2.2 2.2 5 2.2s5-1 5-2.2v-5"/><path d="M21 9v5"/></svg>',
gamepad:'<svg '+_s+'><rect x="2" y="7" width="20" height="10" rx="4"/><path d="M7 12h3M8.5 10.5v3"/><circle cx="15.5" cy="11" r="1" fill="currentColor" stroke="none"/><circle cx="17.5" cy="14" r="1" fill="currentColor" stroke="none"/></svg>',
car:'<svg '+_s+'><path d="M5 11l2-5h10l2 5"/><path d="M3 11h18v5a1 1 0 01-1 1H4a1 1 0 01-1-1z"/><circle cx="7.5" cy="17" r="1.5"/><circle cx="16.5" cy="17" r="1.5"/></svg>',
plane:'<svg '+_s+'><path d="M21 4L3 11l7 3 3 7z"/><path d="M21 4L10 14"/></svg>',
scissors:'<svg '+_s+'><circle cx="6" cy="6" r="2.5"/><circle cx="6" cy="18" r="2.5"/><path d="M8.2 7.8L20 18M8.2 16.2L20 6"/></svg>',
gift:'<svg '+_s+'><rect x="4" y="9" width="16" height="11" rx="1"/><path d="M3 9h18"/><path d="M12 9v11"/><path d="M12 9C11 6 7 6 7 8.5S11 9 12 9M12 9c1-3 5-3 5-.5S13 9 12 9"/></svg>',
dumbbell:'<svg '+_s+'><path d="M6.5 12h11"/><rect x="3" y="9" width="3.5" height="6" rx="1"/><rect x="17.5" y="9" width="3.5" height="6" rx="1"/></svg>',
package2:'<svg '+_s+'><path d="M21 8l-9-5-9 5 9 5z"/><path d="M3 8v8l9 5 9-5V8"/><path d="M12 13v8"/></svg>',
...
laptop:'<svg '+_s+'><rect x="4" y="5" width="16" height="11" rx="1.5"/><path d="M2 19.5h20"/></svg>',
music:'<svg '+_s+'><path d="M9 17V5l11-2v12"/><circle cx="6" cy="17" r="3"/><circle cx="17" cy="15" r="3"/></svg>',
tv:'<svg '+_s+'><rect x="2" y="7" width="20" height="13" rx="2"/><path d="M8 3l4 4 4-4"/></svg>',
paw:'<svg '+_s+'><circle cx="8" cy="7" r="2"/><circle cx="16" cy="7" r="2"/><circle cx="5" cy="12" r="1.8"/><circle cx="19" cy="12" r="1.8"/><path d="M12 21c-3 0-5-1.8-5-4s2-3.5 5-3.5 5 1.3 5 3.5S15 21 12 21z"/></svg>',
shopping:'<svg '+_s+'><circle cx="9" cy="20" r="1.5"/><circle cx="18" cy="20" r="1.5"/><path d="M2 4h2.5l2 11h11l2-8H7"/></svg>',
piggy:'<svg '+_s+'><path d="M16 7l1.5-2.5.5 3.5c1 .8 2 1.8 2 3.5 0 3.3-3.6 6-8 6s-8-2.7-8-6 3.6-6 8-6c1.5 0 2.9.3 4 .8z"/><circle cx="15" cy="11" r="1" fill="currentColor" stroke="none"/><path d="M20 10h2"/><path d="M7 17v3M14 17v3"/></svg>',
book:'<svg '+_s+'><path d="M5 5a2 2 0 012-2h12v16H7a2 2 0 00-2 2z"/><path d="M5 19V5"/></svg>',
beer:'<svg '+_s+'><path d="M6 8h10v11a2 2 0 01-2 2H8a2 2 0 01-2-2z"/><path d="M16 10h2a2 2 0 012 2v3a2 2 0 01-2 2h-2"/><path d="M6 8c0-2 1.5-3 3-3s2-1 3.5-1 2.5 1.5 1.5 4"/></svg>',
hospital:'<svg '+_s+'><rect x="3" y="3" width="18" height="18" rx="3"/><path d="M12 8v8M8 12h8"/></svg>',
bulb:'<svg '+_s+'><path d="M9 18h6M10 21h4"/><path d="M8 13.5a5 5 0 116 0c-.6.5-1 1.2-1 2H9c0-.8-.4-1.5-1-2z"/></svg>',
shower:'<svg '+_s+'><path d="M5 10a7 7 0 0114 0z"/><path d="M5 10h14"/><path d="M9 14v1.5M12 14v2.5M15 14v1.5"/></svg>',
film:'<svg '+_s+'><rect x="3" y="8" width="18" height="12" rx="1.5"/><path d="M3 8l2.5-4 3.5 2 3-2 3.5 2 3-2L21 8"/></svg>',
baby:'<svg '+_s+'><circle cx="12" cy="12" r="8"/><circle cx="9.5" cy="11" r="1" fill="currentColor" stroke="none"/><circle cx="14.5" cy="11" r="1" fill="currentColor" stroke="none"/><path d="M9.5 15a3 3 0 005 0"/></svg>',
ring:'<svg '+_s+'><circle cx="12" cy="15" r="6"/><path d="M9 9l3-4 3 4z"/></svg>',
camera:'<svg '+_s+'><rect x="3" y="7" width="18" height="13" rx="2.5"/><path d="M8 7l1.5-3h5L16 7"/><circle cx="12" cy="13.5" r="3.5"/></svg>',
broom:'<svg '+_s+'><path d="M15 3l-6 8"/><path d="M6 13h8l-1 8H7z"/><path d="M9 17v3M12 17v3"/></svg>',
...
function decodeSavingsNote(note){return String(note||'').replace(/^\[\[okane_source:[a-z_]+\]\]/,'')}
...
function gm(y,m){
    ...
    if(gSh(y,m)>0||d.shopee!==undefined||gCats().some(function(cat){return cat.id==='shopee'}))view.shopee=gSh(y,m);
    if(autoCreated){/* don't persist on read-only auto-create */}
    return view
}
function sm_(y,m,d){var s=gs();if(!s.mo)s.mo={};var out=Object.assign({},d);delete out.shopee;s.mo[mk(y,m)]=out;syncNow(s)}
function computeSavingsBalance(history){var bal=0;(history||[]).forEach(function(h){var amt=Number(h.amount||0);if(h.type==='withdraw')bal=Math.max(0,bal-amt);else bal+=amt});return bal}
function getSavings(){var s=gs();if(!s.savings)s.savings={balance:0,history:[]};var hist=s.savings.history||[];return{balance:computeSavingsBalance(hist),history:hist}}
...
function addTombstone(s,col,id){if(!s._tombstones)s._tombstones={};if(!s._tombstones[col])s._tombstones[col]={};s._tombstones[col][id]=Date.now();return s}
...
function activeCategoryIdsForMonth(d,y,m,spentMap,recurMap){
    ...
    var sm=spentMap||getSpentMap(y,m);
    var rm=recurMap||getRecurringMap(y,m);
    Object.keys(sm).forEach(function(id){if(id!=='other')ids[id]=true});
    Object.keys(rm).forEach(function(id){if(id!=='other')ids[id]=true});
...
async function syncLocalToSupabase(userId) {
    ...
    var savRows = ((s.savings && s.savings.history) || []).map(function(item) {
        return {
            ...
            source: cloudSavingsSource(item.source || 'manual'),
            note: encodeSavingsNote(item.note,item.source)
        };
    });
...
async function fetchRemoteData(userId) {
    ...
    newStore.savings.history = (results[7].data || []).map(function(sh) {
        return {
            ...
            source: decodeSavingsSource(sh.source,sh.note),
            note: decodeSavingsNote(sh.note)
        };
    });
...
function getRecurringMap(y,m){var s=gs(),map={},qk=mk(y,m);(s.recur||[]).forEach(function(r){if(!r||!r.on)return;if(r.startKey&&r.startKey>qk)return;var cat=r.cat||'other';map[cat]=(map[cat]||0)+Number(r.amount||0)});return map}
...
if(prev.y>=1970){
var prevK=mk(prev.y,prev.m),ps=gs();
var hasData=(ps.mo&&ps.mo[prevK])||(ps.dLog&&Object.keys(ps.dLog).some(function(dk){return dk.startsWith(prevK)}));
if(hasData){
...
var dailySpentMap=getDailySpentMap(y,m);
var recurMap=getRecurringMap(y,m);
var spentMap={};
Object.keys(dailySpentMap).forEach(function(k){spentMap[k]=(spentMap[k]||0)+Number(dailySpentMap[k]||0)});
Object.keys(recurMap).forEach(function(k){spentMap[k]=(spentMap[k]||0)+Number(recurMap[k]||0)});
var unbudgetedSpent=0;
Object.keys(dailySpentMap).forEach(function(catId){
if(catId==='other')return;
var bud=Number(d[catId]||0);
if(bud>0)return;
unbudgetedSpent+=Number(dailySpentMap[catId]||0)
});
...
var res={tI:tI,tE:tE,r:r,d:d,otherTotal:otherTotal,savTransfer:savTransfer,recurTotal:recurTotal,carryIn:carryIn,unbudgetedApplied:unbudgetedApplied,carryOut:carryOut,spentMap:spentMap,dailySpentMap:dailySpentMap,recurMap:recurMap};
_mCalcCache[k]=res;
return res
}
function calc(y,m){
...
var chip='';
if(opt.prevExp!==undefined&&Number(opt.prevExp)>0&&Number(tE)>0){
    var pct=Math.round(((tE-opt.prevExp)/opt.prevExp)*100);
    if(Math.abs(pct)>=1){
        var cls=pct>0?'neg':'pos';
        var sign=pct>0?'+':'';
        var lbl=opt.prevLabel||'จากเดือนก่อน';
...
return h}
function tctBarH(){
return '<div class="tct-bar" onclick="openThaiChueayThai()" role="button" tabindex="0" aria-label="ไทยช่วยไทยพลัส"><span class="tct-bar-logo-wrap" aria-hidden="true"><img src="./assets/thai-chueay-thai-logo.png" alt="ไทยช่วยไทย" class="tct-bar-logo"></span></div>'}
...
function getAllExpCats(d,y,m,spentMap,recurMap){
var order={food:0,sav:1,shopee:2,gas:3},ids=activeCategoryIdsForMonth(d,y,m,spentMap,recurMap);
...
// Add cat btn
h+='<div style="padding:4px 10px 8px"><button class="add-cat-btn" onclick="openCat(\'add\')"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>เพิ่มหมวดค่าใช้จ่าย</button></div>';
...
function dailyListH(log, dk){
    ...
    if(log.length > 0){
        ...
        if(sq){h += emptyStateH({icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="11" cy="11" r="7"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>',title:'ไม่พบรายการ',desc:'ลองเปลี่ยนคำค้นหาหรือล้างตัวกรอง'})}
        else{h += emptyStateH({icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="12" y1="13" x2="12" y2="17"/><line x1="10" y1="15" x2="14" y2="15"/></svg>',title:'ยังไม่มีรายการวันนี้',desc:'แตะปุ่ม + ตรงกลางด้านล่างเพื่อบันทึกรายจ่ายแรกของวัน',cta:{text:'+ บันทึกรายจ่าย',onclick:'openQuickAdd()'}})}
    }
    return h;
}
...
function rDailyList(){
    ...
    var overspentCats={};
    var _dsm=getDailySpentMap(cY,sM_);
    allCats.forEach(function(ca){var bud=Number(gm(cY,sM_)[ca.id]||0);if(bud>0){var sp=Number(_dsm[ca.id]||0);if(sp>bud)overspentCats[ca.id]=true}});
    var filteredLog = log.filter(function(x){
...
h+='<div class="ym-total-top"><span class="ym-total-lbl">รวมทั้งปี '+cY+'</span><span class="ym-total-net '+(tr>=0?'year-pos':'year-neg')+'" data-tween-key="ytot-net" data-tween-target="'+tr+'" data-tween-fmt="signed">'+(tr>=0?'+':'\u2212')+fmt(Math.abs(tr))+'</span></div>';
h+='<div class="ym-total-row">';
h+='<div class="ym-total-col"><div class="ym-total-key">รายรับรวม</div><div class="ym-total-val year-pos" data-tween-key="ytot-inc" data-tween-target="'+ti+'" data-tween-fmt="plus">+'+fmt(ti)+'</div></div>';
h+='<div class="ym-total-col"><div class="ym-total-key">รายจ่ายรวม</div><div class="ym-total-val year-neg" data-tween-key="ytot-exp" data-tween-target="'+te+'" data-tween-fmt="minus">\u2212'+fmt(te)+'</div></div>';
h+='</div></div>';
h+='</div></div>';
...
function renderSavings(){var sav=getSavings();var h='<div class="sv-hero dreamblur"><div class="sv-hero-lb">\u0E22\u0E2D\u0E14\u0E1B\u0E31\u0E08\u0E08\u0E38\u0E1A\u0E31\u0E19</div><div class="sv-hero-v">'+fmt(sav.balance)+'</div></div>';
...
if(savTab==='add'){h+='<div class="sv-panel"><div class="sv-panel-t">\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E40\u0E07\u0E34\u0E19\u0E40\u0E01\u0E47\u0E1A</div><input class="inp" type="number" id="svAmt" placeholder="\u0E08\u0E33\u0E19\u0E27\u0E19\u0E40\u0E07\u0E34\u0E19" min="0" style="margin-bottom:8px"><div style="font-size:12px;font-weight:600;margin-bottom:6px">\u0E41\u0E2B\u0E25\u0E48\u0E07\u0E17\u0E35\u0E48\u0E21\u0E32:</div><label class="sv-radio"><input type="radio" name="svSrc" value="remaining" checked>\u0E08\u0E32\u0E01\u0E40\u0E07\u0E34\u0E19\u0E04\u0E07\u0E40\u0E2B\u0E25\u0E37\u0E2D\u0E40\u0E14\u0E37\u0E2D\u0E19\u0E19\u0E35\u0E49</label><label class="sv-radio"><input type="radio" name="svSrc" value="income">\u0E08\u0E32\u0E01\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E2D\u0E37\u0E48\u0E19</label><input class="inp" id="svNote" placeholder="\u0E42\u0E19\u0E49\u0E15" style="margin-bottom:8px"><button class="btn btn-gn btn-full" onclick="doSavAdd()">\u0E1A\u0E31\u0E19\u0E17\u0E36\u0E01</button></div>'}
if(savTab==='wd'){h+='<div class="sv-panel"><div class="sv-panel-t">\u0E16\u0E2D\u0E19\u0E40\u0E07\u0E34\u0E19\u0E40\u0E01\u0E47\u0E1A</div><input class="inp" type="number" id="svWAmt" placeholder="\u0E08\u0E33\u0E19\u0E27\u0E19" min="0" style="margin-bottom:8px"><input class="inp" id="svWNote" placeholder="\u0E40\u0E2D\u0E32\u0E44\u0E1B\u0E43\u0E0A\u0E49\u0E08\u0E48\u0E32\u0E22\u0E04\u0E48\u0E32\u0E2D\u0E30\u0E44\u0E23" style="margin-bottom:8px"><button class="btn btn-rd btn-full" onclick="doSavWd()">\u0E1A\u0E31\u0E19\u0E17\u0E36\u0E01</button></div>'}
// History
h+='<div class="sv-h-lb">\u0E1B\u0E23\u0E30\u0E27\u0E31\u0E15\u0E34</div>';
...
function undoLastDelete(){
    ...
    if(_lastDelete.type==='income'){
        var d=gm(_lastDelete.y,_lastDelete.m);
        d.oI.push(_lastDelete.item);
        sm_(_lastDelete.y,_lastDelete.m,d);
        _lastDelete=null;hideUndo();render();return
    }
...
function openCatDetail(catId){
    ...
    var d=gm(y,m),c=calc(y,m);
    var meta=getCatMeta(catId);
    var budget=Number(d[catId]||0);
    var rec=Number((c.recurMap||{})[catId]||0);
    var spent=Number((c.dailySpentMap||{})[catId]||0);
    var carryCat=(c.carryIn&&c.carryIn.cat&&c.carryIn.cat[catId])?Number(c.carryIn.cat[catId]||0):0;
    var effSpent=spent+rec+carryCat;
    var left=budget-effSpent;
    var pct=budget>0?Math.min((effSpent/budget)*100,100):0;
    var items=[];
    var s=gs(),prefix=mk(y,m);
    if(s.dLog){Object.keys(s.dLog).forEach(function(dk){if(!dk.startsWith(prefix))return;s.dLog[dk].forEach(function(x,i){if((x.cat||'other')===catId)items.push({date:dk,idx:i,x:x})})})}
    ...
    if(items.length===0){
        ...
        h+='<div class="sc" style="background:var(--bg2);padding:4px">';
    ...
    document.getElementById('cdB').innerHTML=h;
    document.getElementById('cdM').classList.add('open');
}
function closeCatDetail(){document.getElementById('cdM').classList.remove('open')}
document.getElementById('cdM').addEventListener('click',function(e){if(e.target===this)closeCatDetail()});
function openEditEntry(dk,idx){
    ...
    var cats=getAllDailyCats();
    var w=getWallets();
    var curCat=cats.find(function(c){return c.id===(it.cat||'other')})||{name:'อื่นๆ',id:'other'};
    var h='';
    ...
    h+='<div><div class="sub-lb" style="padding:0 0 6px">กระเป๋า</div><select class="inp" id="edWal" style="appearance:auto;width:100%"><option value="">ไม่ระบุ</option>'+w.map(function(x){return '<option value="'+x.id+'"'+((it.w||'')===x.id?' selected':'')+'>'+esc(x.name)+'</option>'}).join('')+'</select></div>';
    h+='</div>';
    h+='<div style="margin-top:12px"><div class="sub-lb" style="padding:0 0 6px">เวลา</div><input class="inp" id="edTime" placeholder="HH:MM" value="'+esc(it.t||'')+'" style="width:100%"></div>';
    h+='<div style="margin-top:12px"><div class="sub-lb" style="padding:0 0 6px">บันทึกช่วยจำ</div><input class="qa-note" id="edNote" placeholder="โน้ต" value="'+esc(it.n||'')+'" style="width:100%"></div>';
...
function saveEditEntry(){
    ...
    if(amt<=0)return;
    if(!it.id)it.id=genId('dl');
    it.a=amt;
    var rawTime=(document.getElementById('edTime').value||'').trim();
    it.t=/^([01]\d|2[0-3]):[0-5]\d$/.test(rawTime)?rawTime:(it.t||'');
...
if(_catPopupMode==='manage'&&current.length){
    ...
    h+='</div>'
}else if(_catPopupMode==='manage'){
    h+='<div class="empty-section-note" style="margin:0 0 12px">ยังไม่มีหมวดให้แก้ไข กดเพิ่มหมวดค่าใช้จ่ายก่อน</div>'
}else{
    h+='<div class="empty-section-note" style="margin:0 0 12px">ยังไม่มีหมวดค่าใช้จ่ายของคุณ</div>'
}
if(_catPopupMode==='add'&&suggestions.length){
...
if(_catPopupMode==='add')h+='<button class="add-cat-btn" style="margin-top:12px" onclick="closeCat();openCreateCat()"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>สร้างหมวดค่าใช้จ่ายใหม่</button>';
...
function saveShopee(){var s=gs();if(!s.shM)s.shM={};for(var m=0;m<12;m++){var inp=document.getElementById('sh'+m);s.shM[mk(shY,m)]=inp?Number(inp.value)||0:0;if(s.mo&&s.mo[mk(shY,m)])delete s.mo[mk(shY,m)].shopee}syncNow(s);closeShopee();render()}
...
function openUser(){
    ...
    // Avatar
    var h='<div class="prof-hero dreamblur">';
...
function tweenEl(el){
    var key = el.getAttribute('data-tween-key');
    var target = Number(el.getAttribute('data-tween-target'));
    if(!isFinite(target))return;
    var prev = window._tweens[key];
    window._tweens[key] = target;
    if(prev===undefined||prev===target||!isFinite(prev))return;
    var fmtMode = el.getAttribute('data-tween-fmt')||'plain';
    var dur=420, t0=performance.now();
    function disp(v){
        if(fmtMode==='signed')return (v>=0?'':'-')+fmt(Math.abs(v));
        if(fmtMode==='plus')return '+'+fmt(v);
        if(fmtMode==='minus')return '-'+fmt(v);
        if(fmtMode==='short')return fmtSh(v);
        return fmt(v);
    }
    function step(now){
        var p=Math.min(1,(now-t0)/dur);
        var eased=1-Math.pow(1-p,3);
        var v=prev+(target-prev)*eased;
        el.textContent = disp(v);
        if(p<1)requestAnimationFrame(step);
    }
    requestAnimationFrame(step);
}
function applyTweens(root){
    try{(root||document).querySelectorAll('[data-tween-key]').forEach(tweenEl)}catch(e){}
}

/* Swipe-to-delete on .dl-item rows */
function attachSwipe(root){
    try{(root||document).querySelectorAll('.dl-item:not([data-swipe-init])').forEach(function(item){
        item.setAttribute('data-swipe-init','1');
        var startX=0,startY=0,dx=0,dy=0,dragging=false,locked=false,horiz=false;
        item.addEventListener('pointerdown',function(e){
            if(e.target.closest('button,input,select,a,textarea'))return;
            startX=e.clientX;startY=e.clientY;dx=0;dy=0;dragging=true;locked=false;horiz=false;
        ...
        item.addEventListener('pointermove',function(e){
            ...
            if(!horiz&&!locked){
                if(Math.abs(dx)>8&&Math.abs(dx)>Math.abs(dy)){horiz=true;locked=true;try{item.setPointerCapture(e.pointerId)}catch(_){}}
                else if(Math.abs(dy)>10){dragging=false;item.style.transform='';item.style.transition='';return}
            }
            if(horiz&&dx<0){
                var amt=Math.max(dx,-140);
                item.style.transform='translateX('+amt+'px)';
                item.classList.toggle('swipe-armed',dx<-80);
                e.preventDefault();
            }else if(horiz){
                item.style.transform='';
                item.classList.remove('swipe-armed');
            }
        });
        function end(){
            if(!dragging)return;
            ...
            var armed=dx<-80;
            if(armed){
                var btn=item.querySelector('.cd');
                item.style.transform='translateX(-110%)';
                item.classList.remove('swipe-armed');
                setTimeout(function(){if(btn)btn.click()},240);
            }else{
                item.style.transform='';
                item.classList.remove('swipe-armed');
            }
            if(locked){
                ...
                setTimeout(function(){item.removeEventListener('click',supp,true)},350);
            }
        }
        item.addEventListener('pointerup',end);
        item.addEventListener('pointercancel',end);
        item.addEventListener('pointerleave',function(){if(dragging)end()});
    })}catch(e){}
}

/* Smart category prediction from note keywords */
function getCatHints(){try{return JSON.parse(localStorage.getItem('okane_cat_hints')||'{}')}catch(e){return{}}}
function learnCatHint(note,catId){
    if(!note||!catId||catId==='other')return;
    var hints=getCatHints();
    var words=String(note).toLowerCase().trim().split(/\s+/).filter(function(w){return w.length>=2});
    words.forEach(function(w){
        if(!hints[w])hints[w]={};
        hints[w][catId]=(hints[w][catId]||0)+1;
    });
    try{localStorage.setItem('okane_cat_hints',JSON.stringify(hints))}catch(e){}
}
function predictCatFromNote(note){
    if(!note)return null;
    var hints=getCatHints();
    var words=String(note).toLowerCase().trim().split(/\s+/);
    var scores={};
    words.forEach(function(w){
        var h=hints[w];if(!h)return;
        Object.keys(h).forEach(function(k){scores[k]=(scores[k]||0)+h[k]});
    });
    var best=null,bestScore=0;
    Object.keys(scores).forEach(function(k){if(scores[k]>bestScore){best=k;bestScore=scores[k]}});
    return best;
}
function qaNoteChange(){
    var ni=document.getElementById('qaNote');
    window._qaN=ni?ni.value:'';
    var pred=qaCat?null:predictCatFromNote(window._qaN);
    document.querySelectorAll('.qa-cat[data-cat]').forEach(function(el){
        el.classList.toggle('suggested',!!pred&&el.getAttribute('data-cat')===pred);
    });
}

/* Reusable empty state HTML */
function emptyStateH(opts){
    opts=opts||{};
    var ic=opts.icon||'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z"/></svg>';
    var h='<div class="empty-state">';
    h+='<div class="empty-state-ic">'+ic+'</div>';
    if(opts.title)h+='<div class="empty-state-t">'+esc(opts.title)+'</div>';
    if(opts.desc)h+='<div class="empty-state-s">'+esc(opts.desc)+'</div>';
    if(opts.cta)h+='<button class="btn btn-ac empty-state-cta" onclick="'+opts.cta.onclick+'">'+esc(opts.cta.text)+'</button>';
    h+='</div>';
    return h;
}

/* Hook tween + swipe to render passes */
(function(){
    var origRender=window.render;
    if(typeof origRender==='function'){
        window.render=function(){
            origRender.apply(this,arguments);
            requestAnimationFrame(function(){applyTweens(document);attachSwipe(document)});
        }
    }
    var origRDL=window.rDailyList;
    if(typeof origRDL==='function'){
        window.rDailyList=function(){
            origRDL.apply(this,arguments);
            requestAnimationFrame(function(){attachSwipe(document)});
        }
    }
})();
