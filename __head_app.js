...
h+='<div class="sec" style="animation-delay:.04s"><div class="sec-t"><span>����Ѻ</span><button class="edit-btn'+(editInc?' editing':'')+'" onclick="editInc=!editInc;render()" aria-label="'+(editInc?'�ѹ�֡':'���')+'">'+(editInc?_svgCheck:_svgPencil)+'</button></div><div class="sc">';
...
h+='</div>';
if(d.oI.length>0){h+='<div class="sub-lb">���������</div>';d.oI.forEach(function(x,i){h+=ciItem(x,i,'I',false)})}
h+='<div class="ar"><input class="inp" type="number" id="iA" placeholder="�ӹǹ�Թ" min="0" style="flex:.55"><input class="inp" id="iN" placeholder="��" style="flex:1"><button class="btn btn-gn" style="padding:8px 11px" onclick="addI()">+</button></div>';
h+='</div></div>';

var st=ensureSettings();

// EXPENSES
h+='<div class="sec" style="animation-delay:.08s"><div class="sec-t"><span>��¨���</span><button class="edit-btn'+(editExp?' editing':'')+'" onclick="editExp=!editExp;render()" aria-label="'+(editExp?'�ѹ�֡':'���')+'">'+(editExp?_svgCheck:_svgPencil)+'</button></div><div class="sc">';
...
// Add cat btn
h+='<div style="padding:4px 10px 8px"><button class="add-cat-btn" onclick="openCat()"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>������Ǵ��������</button></div>';
...
h+='</div>';
h+='<div class="reset-area"><button class="reset-btn" onclick="resetMonth()">��ҧ��͹ '+TM[m]+'</button><div class="credit">Credit : Opus 4.6 & Jarasrawee</div></div>';
...
h+='<div class="sec"><div class="sec-t"><span>������������»�</span> <span class="rv pos" style="font-size:12px">'+prog.toFixed(0)+'%</span></div><div class="sc"><div style="padding:4px 16px 0;font-size:11px;color:var(--tx3)">������� '+fmt(ts)+' / '+fmt(goal)+'.-</div><div class="prog-wrap"><div class="prog-bar"><div class="prog-fill pf-gn" style="width:'+Math.min(prog,100)+'%"></div></div></div><div style="padding:8px 16px 0;font-size:11px;color:var(--tx2)">�Թ�������Ѩ�غѹ '+fmt(getSavings().balance)+'.-</div></div></div>';
...
h+='</div></div>';
h+='<div class="sec st-sec tone-gn"><div class="st-h"><div class="st-ic"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2v20"/><path d="M17 5H9.5a3.5 3.5 0 000 7H14.5a3.5 3.5 0 010 7H6"/></svg></div><div class="st-ht"><div class="st-ttl">������������»�</div><div class="st-sub">��˹��ʹ�����������Ѻ progress �˹����»�</div></div></div><div class="st-body">';
h+='<div class="sr" style="border-bottom:none"><div class="sl">������������»�<small>��ӹǳ progress ��»�</small></div><input class="si" style="width:120px" id="stSavGoal" value="'+Number(st.savGoal||50000)+'"></div>';
h+='<div style="margin-top:10px"><button class="btn btn-ac btn-full" onclick="saveSavGoal(&#39;stSavGoal&#39;)">�ѹ�֡������������»�</button></div>';
h+='</div></div>';
